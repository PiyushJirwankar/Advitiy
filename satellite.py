...
class Satellite:
	...
	def getVel(self):	#set velocity in eci

		return self.v_vel_i

	def setPos_J2(self,v_pos):	#set position in eci (earth centered inertial frame)

		self.v_pos_i = v_pos.copy()

	def getPos_J2(self):	#return position in eci

		return self.v_pos_i

	def setVel_J2(self,v_vel):	#set velocity in eci

		self.v_vel_i = v_vel.copy()

	def getVel_J2(self):	#set velocity in eci
